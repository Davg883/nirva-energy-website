...
export default function HomePage() {
  return (
    <>
      ...
      <Section spacing="lg" className="py-32 lg:py-40 xl:py-48 bg-gradient-to-br from-primary-900/20 via-transparent to-accent-500/5">
        <div className="container-wide">
          ...
          <div className="grid lg:grid-cols-3 gap-16 lg:gap-20 xl:gap-24">
            {/* Step 1: Vision */}
            <FadeIn delay={0.2}>
              <div className="text-center group bg-gray-800/30 rounded-3xl p-10 lg:p-12 xl:p-16 border border-gray-700/50 hover:border-accent-500/50 hover:bg-gray-800/50 transition-all duration-500">
                <div className="w-32 h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 bg-gradient-to-br from-accent-500 to-accent-600 rounded-3xl flex items-center justify-center mx-auto mb-10 lg:mb-12 group-hover:scale-110 transition-transform duration-500 shadow-2xl">
                  <span className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900">01</span>
                </div>
                <h3 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-8 lg:mb-10">Vision & Results</h3>
                <p className="text-xl lg:text-2xl xl:text-3xl text-gray-300 mb-10 lg:mb-12 leading-relaxed max-w-lg mx-auto">
                ...
                <Link href="/" className="inline-flex items-center text-accent-500 hover:text-accent-400 font-bold text-xl lg:text-2xl transition-colors group-hover:scale-105 transform duration-300">
            ...
            {/* Step 2: Protocol */}
            <FadeIn delay={0.4}>
              <div className="text-center group bg-gray-800/30 rounded-3xl p-10 lg:p-12 xl:p-16 border border-gray-700/50 hover:border-blue-500/50 hover:bg-gray-800/50 transition-all duration-500">
                <div className="w-32 h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl flex items-center justify-center mx-auto mb-10 lg:mb-12 group-hover:scale-110 transition-transform duration-500 shadow-2xl">
                  <span className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white">02</span>
                </div>
                ...
                <Link href="/protocol" className="inline-flex items-center text-blue-400 hover:text-blue-300 font-bold text-xl lg:text-2xl transition-colors group-hover:scale-105 transform duration-300">
                  Explore Technology
                  <svg className="w-6 h-6 lg:w-8 lg:h-8 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
            ...
            {/* Step 3: Partnership */}
            <FadeIn delay={0.6}>
              <div className="text-center group bg-gray-800/30 rounded-3xl p-10 lg:p-12 xl:p-16 border border-gray-700/50 hover:border-purple-500/50 hover:bg-gray-800/50 transition-all duration-500">
                <div className="w-32 h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 bg-gradient-to-br from-purple-500 to-purple-600 rounded-3xl flex items-center justify-center mx-auto mb-10 lg:mb-12 group-hover:scale-110 transition-transform duration-500 shadow-2xl">
                  <span className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white">03</span>
                </div>
                ...
                <Link href="/partnership" className="inline-flex items-center text-purple-400 hover:text-purple-300 font-bold text-xl lg:text-2xl transition-colors group-hover:scale-105 transform duration-300">
                  Start Partnership
                  <svg className="w-6 h-6 lg:w-8 lg:h-8 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
      ...
      <Section spacing="lg" className="py-32 lg:py-40 xl:py-48">
        <div className="container-wide">
          ...
          <FadeIn delay={0.2}>
            <div className="bg-gray-800/50 rounded-3xl p-10 lg:p-12 xl:p-16 border border-gray-700 text-center hover:border-accent-500/50 hover:bg-gray-800/70 transition-all duration-500 ease-out hover:scale-105 hover:shadow-2xl">
              <div className="w-20 h-20 lg:w-24 lg:h-24 xl:w-28 xl:h-28 bg-accent-500/20 rounded-2xl flex items-center justify-center mx-auto mb-8 lg:mb-10">
                <svg className="w-10 h-10 lg:w-12 lg:h-12 xl:w-14 xl:h-14 text-accent-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                </svg>
              </div>
              <div className="text-5xl lg:text-6xl xl:text-7xl font-bold text-accent-500 mb-4 lg:mb-6">+35%</div>
              <div className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white mb-4 lg:mb-6">Vehicle Utilization</div>
              <div className="text-lg lg:text-xl xl:text-2xl text-gray-400 mb-6 lg:mb-8">68% → 92%</div>
              <div className="text-lg lg:text-xl xl:text-2xl text-gray-300 leading-relaxed">AI-driven route optimization dramatically increased fleet efficiency</div>
            </div>
          </FadeIn>
          
          <FadeIn delay={0.3}>
            <div className="bg-gray-800/50 rounded-3xl p-10 lg:p-12 xl:p-16 border border-gray-700 text-center hover:border-blue-500/50 hover:bg-gray-800/70 transition-all duration-500 ease-out hover:scale-105 hover:shadow-2xl">
              <div className="w-20 h-20 lg:w-24 lg:h-24 xl:w-28 xl:h-28 bg-blue-500/20 rounded-2xl flex items-center justify-center mx-auto mb-8 lg:mb-10">
                <svg className="w-10 h-10 lg:w-12 lg:h-12 xl:w-14 xl:h-14 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div className="text-5xl lg:text-6xl xl:text-7xl font-bold text-blue-400 mb-4 lg:mb-6">-98%</div>
              <div className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white mb-4 lg:mb-6">Processing Time</div>
              <div className="text-lg lg:text-xl xl:text-2xl text-gray-400 mb-6 lg:mb-8">12 min → 7.3 sec</div>
              <div className="text-lg lg:text-xl xl:text-2xl text-gray-300 leading-relaxed">Autonomous agents process orders instantly from email and web forms</div>
            </div>
          </FadeIn>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-20 xl:gap-24">
            <FadeIn delay={0.2}>
              <div className="text-center group">
                <div className="w-40 h-40 lg:w-48 lg:h-48 xl:w-56 xl:h-56 bg-accent-500/20 rounded-full flex items-center justify-center mx-auto mb-10 lg:mb-12 group-hover:scale-110 transition-transform duration-500 shadow-2xl">
                  <span className="text-5xl lg:text-6xl xl:text-7xl font-bold text-accent-500">94.7%</span>
                </div>
                <h3 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6 lg:mb-8">Prediction Accuracy</h3>
                <p className="text-gray-400 text-xl lg:text-2xl xl:text-3xl leading-relaxed">Market forecasting and demand prediction reliability</p>
              </div>
            </FadeIn>
            
            <FadeIn delay={0.4}>
              <div className="text-center group">
                <div className="w-40 h-40 lg:w-48 lg:h-48 xl:w-56 xl:h-56 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-10 lg:mb-12 group-hover:scale-110 transition-transform duration-500 shadow-2xl">
                  <span className="text-5xl lg:text-6xl xl:text-7xl font-bold text-blue-400">91.2%</span>
                </div>
                <h3 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6 lg:mb-8">Decision Confidence</h3>
                <p className="text-gray-400 text-xl lg:text-2xl xl:text-3xl leading-relaxed">AI system confidence in autonomous decisions</p>
              </div>
            </FadeIn>
            
            <FadeIn delay={0.6}>
              <div className="text-center group">
                <div className="w-40 h-40 lg:w-48 lg:h-48 xl:w-56 xl:h-56 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-10 lg:mb-12 group-hover:scale-110 transition-transform duration-500 shadow-2xl">
                  <span className="text-5xl lg:text-6xl xl:text-7xl font-bold text-green-400">87.3%</span>
                </div>
                <h3 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6 lg:mb-8">Learning Rate</h3>
                <p className="text-gray-400 text-xl lg:text-2xl xl:text-3xl leading-relaxed">Continuous improvement and adaptation speed</p>
              </div>
            </FadeIn>
            
            <FadeIn delay={0.8}>
              <div className="text-center group">
                <div className="w-40 h-40 lg:w-48 lg:h-48 xl:w-56 xl:h-56 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-10 lg:mb-12 group-hover:scale-110 transition-transform duration-500 shadow-2xl">
                  <span className="text-5xl lg:text-6xl xl:text-7xl font-bold text-purple-400">99.8%</span>
                </div>
                <h3 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6 lg:mb-8">System Reliability</h3>
                <p className="text-gray-400 text-xl lg:text-2xl xl:text-3xl leading-relaxed">Uptime and operational consistency</p>
              </div>
            </FadeIn>
          </div>
        </div>
